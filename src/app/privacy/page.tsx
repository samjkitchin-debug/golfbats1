  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-5 py-10 text-black">
      ...
      <div className="space-y-5 text-base leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold">What information is stored</h2>

          <h3 className="mt-3 text-sm font-semibold text-gray-900">Member profile data</h3>
          <p className="mt-1">
          ...
          <h3 className="mt-4 text-sm font-semibold text-gray-900">Passport information (optional)</h3>
          <p className="mt-1">
        ...
        <section>
          <h2 className="text-xl font-semibold">Access, visibility, and control</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold">Member responsibility</h2>
