/**
 * Logistics Pickup Editor
 * 
 * For carpool/away day scenarios where pickup point and time matter.
 * Fields: pickup point, pickup time, driver/seats (optional)
 */
...
type LogisticsPickupEditorProps = {
...
export function LogisticsPickupEditor({
  phase2Form,
  updatePhase2Form,
  phase2Posted,
  phase2Editing,
}: LogisticsPickupEditorProps) {
  return (
    <div className="grid gap-3 md:grid-cols-2">
      <label className="block">
        <div className="text-sm font-medium text-foreground">Pickup time</div>
      ...
      <label className="block">
        <div className="text-sm font-medium text-foreground">Pickup point</div>
        {phase2Posted && !phase2Editing ? (
          <div className="mt-1 w-full rounded-lg border border-border px-3 py-2 text-sm bg-background text-foreground">
          ...
          <input
            ...
            placeholder="e.g. Marina Bay MRT Station"
          />
        )}
      </label>
