...
export default function GroupAdminDashboard() {
  ...
  useEffect(() => {
    ...
    async function loadData() {
      try {
        const [tripsData, coursesData] = await Promise.all([loadTrips(currentGroupId), loadCourses()]);
        setTrips(tripsData);
  ...
  useEffect(() => {
    document.title = "DayForeIt - Admin";
  }, []);
  ...
  function onDeleteTrip(tripId: number) {
    ...
    setOpenMenuTripId(null); // Close menu when showing delete modal
  }
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <div className="md:hidden flex items-center gap-2">
                        ...
                        <button
                          ...
                          onClick={() => router.push(`/admin/g/${groupSlug}/trips/${t.id}`)}
                        >
                          Manage
                        </button>
                      </div>
