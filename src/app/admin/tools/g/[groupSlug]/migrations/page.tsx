...
export default async function MigrationsPage({
  ...
  if (!user) {
    redirect(`/login?next=/admin/tools/g/${encodeURIComponent(groupSlug)}/migrations`);
  }
  ...
  return (
    <div>
      <h1 className="text-xl font-semibold text-foreground mb-2">Cross-group migrations</h1>
      <p className="text-sm text-secondary mb-6">
        Tools for moving data between groups. This is a rare tool and not part of the daily admin
        workshop.
      </p>
